...
class App extends React.Component {
  ...
  getTransaction() {
    ...
    axios
      ...
      .then(response => {
        console.log(
          "Response at route '/product/${productId}'",
      ...
      <div>
        <div>
          <div className="stupiddivTravis">
            <div className="price_inside_buybox">${this.state.priceStr}</div>
            <br></br>
          </div>
          <div>
            <a href="#Saskatchewanizon">FREE Shipping</a>
          </div>
          on orders over $25.00 shipped by Saskatchewanizon or get
          <div className="boldTravis">
            Fast, Free Shipping with{" "}
            <a href="#Saskatchewanizon">Saskatchewanizon Prime</a>
          </div>
          <br></br>
          <div className="boldTravis">
            Get it as soon as Thursday, Feb. 13 - Friday, Feb. 14
          </div>
          <span className="boldTravis"> if you choose Two-Day Shipping </span>
          at checkout.
          <div className="boatsnTravis">Usually ships within 6 days.</div>
          <br></br>
          ...
          <div className="stupiddivTravis">
            <br></br>
            <button className="buynowbox">Buy Now</button>
          </div>
          <div className="boatsnTravis">
            <br></br>
            Ships from and sold by{" "}
            <a href="#Saskatchewanizon">Saskatchewanizon.com</a>
          </div>
          <br></br>
          <div className="boatsnTravis">
            {" "}
            <label className="container">
              Yes, I want fast, FREE Delivery
              <div>with Saskatchewanizon Prime</div>{" "}
            </label>
            <input className="inputTravis" type="checkbox"></input>
          </div>
          <br></br>
          <br></br>
          <div className="boatsnTravis" type="checkbox">
            Enjoy fast, FREE delivery, exclusive deals and
            <div>award-winning movies & TV shows with Prime </div>
            <div>Start saving today with Fast, FREE Delivery</div>
            <br></br>
          </div>
          <br></br>
          <div className="boatsnTravis">
            {" "}
            <a href="#Saskatchewanizon">Select delivery location</a>
          </div>
        </div>
      </div>
    );
